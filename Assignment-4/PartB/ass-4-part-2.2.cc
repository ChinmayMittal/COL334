  ...
  if (printRoutingTables)
    {
      ...
      routingHelper.PrintRoutingTableAt (Seconds (49.0), a, routingStream);
      routingHelper.PrintRoutingTableAt (Seconds (49.0), b, routingStream);
      routingHelper.PrintRoutingTableAt (Seconds (49.0), c, routingStream);
 

      routingHelper.PrintRoutingTableAt (Seconds (51.0), a, routingStream);
      routingHelper.PrintRoutingTableAt (Seconds (51.0), b, routingStream);
      routingHelper.PrintRoutingTableAt (Seconds (51.0), c, routingStream);
      ...
      routingHelper.PrintRoutingTableAt (Seconds (150.0), a, routingStream);
      routingHelper.PrintRoutingTableAt (Seconds (150.0), b, routingStream);
      routingHelper.PrintRoutingTableAt (Seconds (150.0), c, routingStream);  
